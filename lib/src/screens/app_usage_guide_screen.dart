  ...
  void initState() {
    ...
    _allSections = [
      ...
      _GuideSectionData(
        ...
        title: 'ميزات جديدة',
        content:
            'ما الجديد في هذا الإصدار:\n\n• تحسين شاشة الإعدادات وإضافة حوارات مخصصة للخصوصية والشروط\n• صفحة دليل استخدام تفاعلية مع فهرس وبحث\n• تحسينات على تجربة الطباعة والثيم الداكن\n• توضيحات أفضل في رسائل الأخطاء المرتبطة بقاعدة البيانات\n• تحسين أداء الاستعلامات وعرض القوائم\n\nتلميح: راجع قسم التقارير لاستكشاف قدرات التحليل الجديدة.',
      ),
      _GuideSectionData(
